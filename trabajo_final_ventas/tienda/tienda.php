...
while ($producto = mysqli_fetch_assoc($resultado)) {
  ...
  echo "<img src='img/" . $producto["imagen"] . "' alt='" . $producto["nombre_producto"] . "'>";
  echo "<p>Precio: $" . $producto["precio"] . "</p>";
  echo "<button class='comprar-btn' data-id='" . $producto["id"] . "' data-cantidad='" . $producto["cantidad"] . "'>Comprar</button>";
